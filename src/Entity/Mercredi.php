...
use App\Repository\MercrediRepository;
use ApiPlatform\Core\Annotation\ApiResource;

#[ORM\Entity(repositoryClass: MercrediRepository::class)]
...
class Mercredi
{
    ...
    #[ORM\OneToOne(inversedBy: 'mercredi', targetEntity: Commerce::class, cascade: ['persist', 'remove'])]
