...
use App\Repository\JeudiRepository;
use ApiPlatform\Core\Annotation\ApiResource;

#[ORM\Entity(repositoryClass: JeudiRepository::class)]
#[ApiResource]
class Jeudi
{
    #[ORM\Id]
    ...
    #[ORM\OneToOne(inversedBy: 'jeudi', targetEntity: Commerce::class, cascade: ['persist', 'remove'])]
